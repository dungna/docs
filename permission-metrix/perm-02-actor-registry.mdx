...
| --- | --- | --- | --- |
| actor\_id | All | ID actor kỹ thuật | user\_id, staff\_id, partner\_id, service\_id |
| actor\_type | All | Customer/Workforce/Partner/System | Customer |
| party\_id | Customer | Party/customer reference | PTY-001 |
| workforce\_id | Workforce | Staff/agent identifier | STF-001 |
| partner\_id | Partner | Partner identifier | MB, CIMB |
| role\_code | Workforce/System | Role nghiệp vụ/kỹ thuật | CLAIM\_ASSESSOR |
| org\_scope | Workforce | Chi nhánh/vùng/team | REGION\_HN |
| product\_scope | Workforce/Partner | Product allowed | INSURANCE, LENDING |
| certification\_status | Agent/Workforce | Certification còn hiệu lực không | ACTIVE |
| assigned\_case\_id | Workforce | Case được giao | CASE-001 |
| device\_trust\_level | Customer/Workforce | Trust của thiết bị | TRUSTED/UNKNOWN |